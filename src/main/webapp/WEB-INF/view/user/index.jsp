            ...
            success:function (response) {
                ...
                response.list.forEach((value) => {
                    dynamicHtml += "" +
                        ...
                        "        <a href='${pageContext.request.contextPath}/invitation/" + value.invitationId + "' >" + value.content + "</a>\n" +
                        ...
                        "            <div class=\"card-body\">\n" +
                        "                <a href='${pageContext.request.contextPath}/invitation/" + value.invitationId + "' >" + value.invitation + " </a>\n" +
                        "            </div>\n" +
                        "        </div>\n" +
        ...
        $.ajax({
            ...
            success:function (response) {
                ...
                response.list.forEach((value) => {
                    invitationsHtml += "" +
                        "    <li class=\"list-group-item d-flex flex-column\">\n" +
                        "        <a href='${pageContext.request.contextPath}/invitation/" + value.invitationId + "'>" + value.invitationTitle + "</a>\n" +
                        "        <p class=\"time text-secondary m-0\">\n" +
                        "            发帖于" + value.communityName + "社区&nbsp&nbsp" + dateFormat("YYYY-mm-dd",value.time) + "\n" +
                        "        </p>\n" +
                        "    </li>"
                })
            ...
            success:function (response) {
                ...
                response.list.forEach((value) => {
                    noticesHtml += "" +
                        "    <li class=\"list-group-item d-flex flex-column\">\n" +
                        "        <div class=\"d-flex\">\n" +
                        "            <a href=\"#\">" + value.username + ":" + value.content.replace(/<[^>]+>/g, "") + "</a>\n" +
